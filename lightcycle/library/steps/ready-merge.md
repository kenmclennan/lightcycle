...
1. `lc show TASK` for the story's pr artifact (type=pr); open it on GitHub.
...
4. After they merge: `lc done TASK merged` (-> cleanup).
5. If it needs more code instead of merging: `lc done TASK changes` (-> build) with a note saying
