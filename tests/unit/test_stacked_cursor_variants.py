...
class TestPriorityStackedRebuildRendersEachRowOnce(unittest.TestCase):
    def _launch(self):
        ...
        store.edit_node(_PRIORITY_ID_A + "-i", project=_PRIORITY_PROJECT)
        ...
        store.edit_node(_PRIORITY_ID_B + "-i", project=_PRIORITY_PROJECT)
